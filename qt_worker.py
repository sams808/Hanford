...
for operations heavy enough to freeze the UI thread: loading/cleaning the
full dataset, building correlation matrices, PCA/clustering, the Seaborn
plot-suite export, GlassNet predictions.
