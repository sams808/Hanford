...
do the heavyweight imports (qt_shell pulls in matplotlib, scipy, sklearn,
polars, networkx, every workspace) run — so the user sees the logo within
~1 s instead of staring at nothing for the whole import phase.
"""
...
def main() -> int:
    ...
    splash = None
    splash_shown_at = 0.0
    splash_path = asset_path("ember_splash.png")
